/*************************************************************************
    > File Name: ExampleVH.cpp
    > Author: bjzhang03
    > Mail: bjzhang03@outlook.com
    > Created Time: Fri 28 Oct 2016 10:20:02 PM EDT
 ************************************************************************/
...
int main(int argc,char * argv[])
{
	...
	gtk_window_set_title(GTK_WINDOW(window),"Vbox and Hbox Text");
	...
	gtk_box_pack_start(GTK_BOX(hbox),label3,FALSE,TRUE,5);
